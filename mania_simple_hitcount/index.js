...
socket.onmessage = event => {
    try {
        ...
        if (tH300g !== play.hits.geki){
            ...
            if(tTotal != 0){
                let temp = Math.floor((tH300g / tTotal) * 200);
                bar_h300g.style.width = temp + 'px';
            }
        }
        if (tH300 !== play.hits[300]){
            ...
            if(tTotal != 0){
                let temp = Math.floor((tH300 / tTotal) * 200);
                bar_h300.style.width = temp + 'px';
            }
        }
        if (tH200 !== play.hits.katu){
            ...
            if(tTotal != 0){
                let temp = Math.floor((tH200 / tTotal) * 200);
                bar_h200.style.width = temp + 'px';
            }
        }
        if (tH100 !== play.hits[100]){
            ...
            if(tTotal != 0){
                let temp = Math.floor(((tH100+ tH50 + tMiss) / tTotal) * 200);
                bar_bad.style.width = temp + 'px';
            }
        }
