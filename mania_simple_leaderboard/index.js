...
function create_ranking_panel(){
    if (isEmptyObject(beatmap_score) !== true) {
        ...
        for (var i = 0; i < Object.keys(beatmap_score).length; i++) {
            ...
            rank_temp.style.top = 10 + (100 * i) + 'px';
        ...
        rank_temp.style.backgroundColor = bg_value;
        rank_temp.style.top = (Object.keys(beatmap_score).length * 100 + 10) +'px';
        ...
        if (Object.keys(beatmap_score).length <= 4) {
            ...
            rank_container.style.top = (0 - (Object.keys(beatmap_score).length - 4) * 100) + 'px';
        } else {
            rank_container.style.top = (0 - (position - 2) * 100) + 'px';
        }
            ...
            if (state !== menu.state) {
                ...
                if (state == 2) {
                                ...
                                if(isEmptyObject(beatmap_data) !== true){
                                    ...
                                    if(s == 4 || s == 3 || s == 2 || s == 1){
                                        ...
                                        if (slots !== null) {
                                            ...
                                            let rank_temp = document.getElementById(`rank_box_now`);
                                            rank_temp.style.top = ((slots.length - 1) * 100 + 10) + 'px';
                                            ...
                                            //#1, #2, #3
                                                ...
                                                rank_container.style.top = ((0 - (slots.length - 5)) * 100) + 'px';
                                            } else {
                                                rank_container.style.top = (0 - (position - 2) * 100) + 'px';
                                            }
                                            leaderboard_section.style.opacity = 1;
                    ...
                    setTimeout(function () {
                        ...
                        position = 0;
                        rank_container.style.top = '-4600px';
                        temp = true;
                        slots = {};
                    }, 500);
                }
                        ...
                        while (temp == true) {
                            if (position == 0) {
                                if (expected_temp <= beatmap_score[position].score) {
                                    ...
                                    rank_down_box.style.top = (position * 100 + 10) + 'px';
                                    rank_box_now.style.top = ((position + 1) * 100 + 10) + 'px';
                                    position = position + 1;
                                ...
                                if (expected_temp > parseInt(beatmap_score[position - 1].score)) {
                                    ...
                                    rank_up_box.style.top = (position * 100 + 10) + 'px';
                                    rank_box_now.style.top = ((position - 1) * 100 + 10) + 'px';
                                    position = position - 1;
